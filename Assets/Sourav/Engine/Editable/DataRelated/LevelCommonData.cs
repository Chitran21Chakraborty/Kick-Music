...
namespace Sourav.Engine.Editable.DataRelated
{
	...
	public class LevelCommonData : CommonData
	{
		...
		public List<int> UnlockedElement
		{
			get { return game.unlockedElement; }
			set
			{
				game.unlockedElement = value;
				DataChanged();
			}
		}

		public List<Vector3Int> UnlockedMusicalElementIndex
		{
			get { return game.unlockedMusicalItemIndex; }
			set { game.unlockedMusicalItemIndex = value; DataChanged(); }
		}
		...
		public void SetDefault()
		{
			...
			game.unlockedElement = new List<int>();
			for (int i = 0; i < 5; i++)
			{
				if (i < 1)
				{
					UnlockedElement.Add(1);
				}
				else
				{
					UnlockedElement.Add(0);
				}
			}

			game.unlockedMusicalItemIndex = new List<Vector3Int>();
			for (int i = 0; i < 4; i++)
			{
				UnlockedMusicalElementIndex.Add(new Vector3Int(0, 0, 0));
			}
		...
		[Space(10)] 
		[Header("Music.IO Related")]
		public int _count;
		public Camera dragCamera;
		public Camera instrumentsCamera;
		public int tick;
		public bool isSpawning;
		public bool hasGameStarted;
		public int currentStageCoin;
		public GameObject[] draggableObjects;
		public List<ReceiverComponent> _receiverComponents = new List<ReceiverComponent>();
		public List<SenderComponent> _SenderComponents = new List<SenderComponent>();
		public List<DragMusicalElement> currentDraggableElements = new List<DragMusicalElement>();
		public List<GameObject> musicalDummyInstruments;
		public ArrowPump arrowPump;
		public bool doNextLevel = false;
	...
	public class SaveGame
	{
		...
		public List<int> unlockedElement;
		public List<Vector3Int> unlockedMusicalItemIndex;
