...
namespace Sourav.Utilities.Scripts.Components
{
    public class ElementRotation : GameElement
    {
        ...
        [SerializeField] private float nextAngle;
        

        [SerializeField] private bool rotationManuallyStopped;
        [SerializeField] private int currentDirectionMultiplier;
        [SerializeField] private bool startToFinish;
